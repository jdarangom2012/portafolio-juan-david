...
// Contact Form Handling (sin backend - funcional)
contactForm.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        const mailtoLink = `mailto:jdarangom2012@gmail.com?subject=${encodeURIComponent(data.subject)}&body=${encodeURIComponent(
            `Nombre: ${data.name}\nEmail: ${data.email}\n\nMensaje:\n${data.message}`
        )}`;
        ...
        showNotification('¡Formulario procesado! Se abrirá tu cliente de correo.', 'success');
        contactForm.reset();
        ...
        showNotification('Error al procesar el formulario. Por favor, intenta de nuevo.', 'error');
    } finally {
        // Reset button
